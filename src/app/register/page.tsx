...
export default function RegisterPage() {
    ...
    const onSubmit = async (e: React.FormEvent) => {
        ...
        // (opsional) redirect email verification
        ...
        // Jika email confirmation aktif, Supabase akan kirim link verifikasi (Mailpit utk local dev)
        if (data?.user && !data.user?.confirmed_at) {
            setMsg('Akun dibuat. Cek email kamu untuk verifikasi.')
        } else {
            // kalau verification dimatikan, user sudah login
